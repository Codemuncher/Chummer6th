...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt">
    ...
    <xsl:template name="print_personal_data">
        <table class="stats general">
            ...
            <tr>
                <td>
                    <xsl:value-of select="$lang.Alias" />
                </td>
                <td colspan="3">
                    <strong>
            ...
            <tr>
                ...
                <xsl:choose>
                    <xsl:when test="qualities/quality[name='Mystic Adept']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                            <strong>Mystic Adept</strong>
                        </td>
                    </xsl:when>
                    <xsl:when test="qualities/quality[name='Adept']">
                        <td>
                    ...
                    <xsl:when test="qualities/quality[name='Aspected Magician']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                            <strong>Aspected Magician</strong>
                        </td>
                    </xsl:when>
                    <xsl:when test="qualities/quality[name='Magician']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                    ...
                    <xsl:when test="qualities/quality[name='Enchanter']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                            <strong>Enchanter</strong>
                        </td>
                    </xsl:when>
                    <xsl:when test="qualities/quality[name='Explorer']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                    ...
                    <xsl:when test="qualities/quality[name='Apprentice']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                    ...
                    <xsl:when test="qualities/quality[name='Aware']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                    ...
                    <xsl:when test="qualities/quality[name='Technomancer']">
                        <td>
                            <xsl:value-of select="$lang.Special" />
                        </td>
                        <td>
                            <strong>Technomancer</strong>
                        </td>
                    </xsl:when>
                    <xsl:otherwise>
                        <td></td>
            ...
            <tr>
                ...
                <td style="white-space: nowrap;">
                    <strong>
                        <xsl:value-of select="liftweight" />/<xsl:value-of select="carryweight" />
                    </strong>
                </td>
            </tr>
            <tr>
    ...
    <xsl:template name="print_attributes">
        <table class="stats general">
            ...
            <xsl:if test="attributes/attributecategory">
                <tr>
                    ...
                    <td style="white-space: nowrap;" colspan="3">
                        <strong>
                            <xsl:value-of select="attributes/attributecategory" />
                        </strong>
                    </td>
                </tr>
            </xsl:if>
            ...
            <tr>
                ...
                <td style="white-space: nowrap;">
                    <xsl:value-of select="$lang.Essence" />
                </td>
                <td style="white-space: nowrap;">
                    <strong>
            ...
            <tr>
                <td colspan="2">
                    <xsl:value-of select="$lang.RiggerInitiative" />
                </td>
                <td colspan="2">
                    <strong>
            ...
            <tr>
                <td colspan="3">
                    <xsl:value-of select="$lang.Overflow" />
                </td>
                <td>
                    <strong>
                        <xsl:value-of select="cmoverflow - 1" />
                    </strong>
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    <xsl:value-of select="$lang.PhysicalNaturalRecovery" />
                </td>
                <td>
                    <strong>
                        <xsl:value-of select="physicalcmnaturalrecovery" />
                    </strong>
                </td>
            </tr>
            <tr>
        ...
        <table class="stats general">
            <xsl:if test="mainmugshotbase64 != ''">
                <tr>
                    <td colspan="2">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Mugshot" />]
                        </div>
                    </td>
                </tr>
                <tr>
            ...
            <xsl:if test="buildmethod = 'Priority' or buildmethod = 'SumtoTen'">
                ...
                <tr>
                    ...
                    <td>
                        <strong>
                            <xsl:value-of select="prioritymetatype" />
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <strong>
                            <xsl:value-of select="priorityattributes" />
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <strong>
                            <xsl:value-of select="priorityspecial" />
                        </strong>
                    </td>
                </tr>
                <tr>
                    <td>
                        <xsl:value-of select="$lang.Skills" />
                    </td>
                    <td>
                        <strong>
                            <xsl:value-of select="priorityskills" />
                        </strong>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <strong>
                            <xsl:value-of select="priorityresources" />
                        </strong>
                    </td>
                </tr>
            </xsl:if>
                            ...
                            <tr>
                                <td colspan="3">
                                    <strong>
                                        <u>
                                            <xsl:text> </xsl:text>
                                            <xsl:value-of select="$lang.SkillGroups" />
                                        </u>
                                    </strong>
                                </td>
                            </tr>
            ...
            <xsl:if test="(position() &lt; $half_count)=$condition">
                ...
                <xsl:if test="notes!=''">
                    <tr>
                        ...
                        <td colspan="3">
                            <xsl:call-template name="print_notes">
                                <xsl:with-param name="linebreak" select="boolean(false())" />
                            </xsl:call-template>
                        </td>
                    </tr>
                </xsl:if>
                ...
                <xsl:copy>
                    <xsl:if test="../../gears/gear[name=current()/name]">
                        <xsl:element name="qty">
                            <xsl:value-of select="../../gears/gear[name=current()/name]/qty" />
                        </xsl:element>
                    </xsl:if>
                    <xsl:copy-of select="*" />
                </xsl:copy>
        ...
        <xsl:if test="count(msxsl:node-set($sorted_ranged)/*) &gt; 0  or  count(msxsl:node-set($sorted_ammunition)/*) &gt; 0">
            ...
            <table class="stats armory">
                <tr>
                    <td colspan="8">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.RangedWeapons" />]
                        </div>
                    </td>
                </tr>
                <tr class="smallheader">
    ...
    <xsl:template name="print_melee_weapons">
        ...
        <table class="stats armory">
            <tr>
                <td colspan="6">
                    <div class="bigheader">
                        [<xsl:value-of select="$lang.MeleeWeapons" />]
                    </div>
                </td>
            </tr>
            <tr class="smallheader">
                    ...
                    <tr>
                        ...
                        <td>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    <td>
                                        <xsl:value-of select="$lang.Acceleration" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="$lang.DeviceRating" />
                                    </td>
                                    <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <table>
                                    <tr class="smallheader">
                                        <td>
                                            <xsl:value-of select="$lang.Mount" />
                                        </td>
                                        <td>
                                            <xsl:value-of select="$lang.Weapon" />
                                        </td>
    ...
    <xsl:template name="short_mount_name">
        <xsl:choose>
            <xsl:when test="contains(../../name, 'Heavy')">
                <xsl:value-of select="$lang.Heavy" />
            </xsl:when>
            <xsl:otherwise>
                <xsl:value-of select="$lang.Standard" />
            </xsl:otherwise>
        </xsl:choose>
        <xsl:if test="contains(../../name, 'Manual')">
            <xsl:text>, </xsl:text>
            <xsl:value-of select="$lang.Manual" />
        </xsl:if>
    </xsl:template>
        ...
        <xsl:if test="count(cyberwares/cyberware) &gt; 0">
            ...
            <table class="stats machine">
                <tr>
                    <td colspan="3">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Cyberware" />]
                        </div>
                    </td>
                </tr>
                <tr class="smallheader">
                    ...
                    <td>
                        <xsl:value-of select="$lang.Grade" />
                    </td>
                </tr>
        ...
        <xsl:if test="count(msxsl:node-set($sorted_devices)/*) &gt; 0">
            ...
            <table class="stats matrix">
                <tr>
                    <td colspan="5">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.MatrixDevices" />]
                        </div>
                    </td>
                </tr>
                <tr class="smallheader">
    ...
    <xsl:template name="print_matrix_device_stats">
        ...
        <tr>
            ...
            <td>
                <xsl:value-of select="8 + ceiling(devicerating div 2)" />
            </td>
            <td>
        ...
        <xsl:for-each select="msxsl:node-set($list)/*">
            <xsl:if test="(position() &lt; $list_half_count)=$condition">
                ...
                <xsl:if test="( category_tag!=preceding-sibling::gear[1]/category_tag or position()=1 ) and category_tag!='Special'">
                    <li>
                        <strong>
                            <xsl:value-of select="category_tag" />
                        </strong>
                    </li>
                </xsl:if>
                <li>
        ...
        <xsl:if test="count(spirits/spirit) &gt; 0">
            ...
            <table class="stats matrix">
                <tr>
                    <td colspan="2">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Sprites" />]
                        </div>
                    </td>
                </tr>
                <xsl:for-each select="spirits/spirit">
                    ...
                    <tr>
                        <td>
                            <xsl:value-of select="name" />
                            <xsl:if test="crittername!=''">
                                (<xsl:value-of select="crittername" />)
                            </xsl:if>
                            <xsl:choose>
                        ...
                        <td>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/cha" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.DataProcessing" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="spiritattributes/log" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/int" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Firewall" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="spiritattributes/wil" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <xsl:value-of select="8 + ceiling(force div 2)" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Initiative" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="spiritattributes/ini" />
                                        <xsl:text>+4d6</xsl:text>
                                    </td>
                                </tr>
                            </table>
                        </td>
        ...
        <xsl:if test="count(complexforms/complexform) &gt; 0">
            ...
            <table class="stats matrix">
                ...
                <tr class="smallheader">
                    ...
                    <td>
                        <xsl:value-of select="$lang.FadingValue" />
                    </td>
                </tr>
        ...
        <xsl:if test="submersiongrade &gt; 0 or count(metamagics/metamagic) &gt; 0">
            ...
            <table class="stats matrix">
                <tr>
                    <td>
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Submersion" />]
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <br />
                        <strong>
                            <xsl:value-of select="$lang.Echoes" />
                        </strong>
                        <ul>
        ...
        <xsl:if test="count(aiprograms/aiprogram) &gt; 0">
            ...
            <table class="stats matrix">
                ...
                <tr class="smallheader">
                    ...
                    <td>
                        <xsl:value-of select="$lang.Requires" />
                    </td>
                </tr>
    ...
    <xsl:template name="print_magic">
        <table class="stats magic">
            ...
            <tr>
                <td>
                    <xsl:value-of select="$lang.Awakened" />
                </td>
                <td colspan="3">
                    <strong>
                        <xsl:choose>
                            <xsl:when test="qualities/quality[name='Adept']">
                                <xsl:value-of select="$lang.Adept" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Mystic Adept']">
                                <xsl:value-of select="$lang.MysticAdept" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Magician']">
                                <xsl:value-of select="$lang.Magician" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Aspected Magician']">
                                <xsl:value-of select="$lang.AspectedMagician" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Enchanter']">
                                <xsl:value-of select="$lang.Enchanter" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Explorer']">
                                <xsl:value-of select="$lang.Explorer" />
                            </xsl:when>
                            <xsl:when test="qualities/quality[name='Apprentice']">
                                <xsl:value-of select="$lang.Apprentice" />
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:choose>
                                    <xsl:when test="magenabled = 'True'">
                                        <xsl:value-of select="$lang.Aware" />
                                    </xsl:when>
                                    <xsl:otherwise>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <strong>
                            ...
                            <span style="color:grey; font-size: 10px; vertical-align: bottom;">
        ...
        <xsl:if test="count(spirits/spirit) &gt; 0">
            ...
            <table class="stats magic">
                <tr>
                    <td colspan="2">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Spirits" />]
                        </div>
                    </td>
                </tr>
                <xsl:for-each select="spirits/spirit">
                        ...
                        <td>
                            <table style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/bod" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Willpower" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/agi" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Logic" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/rea" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Intuition" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="spiritattributes/str" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.Charisma" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="ceiling(spiritattributes/bod div 2) + 8" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="$lang.StunTrack" />
                                    </td>
                                    <td>
                                        <xsl:value-of select="ceiling(spiritattributes/wil div 2) + 8" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
    ...
    <xsl:template name="print_adept_powers">
        <table class="stats magic">
            <tr>
                <td>
                    <div class="bigheader">
                        [<xsl:value-of select="$lang.AdeptPowers" />]
                    </div>
                </td>
            </tr>
        ...
        <xsl:if test="initiategrade &gt; 0 or count(metamagics/metamagic) &gt; 0">
            <table class="stats magic">
                <tr>
                    <td>
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Initiation" />]
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <strong>
                            <xsl:value-of select="$lang.InitiateGrade" />: <xsl:value-of select="initiategrade" />
                        </strong>
                        <br />
                        <xsl:if test="count(arts/art) &gt; 0">
                            <strong>
                                <xsl:value-of select="$lang.Arts" />
                            </strong>
                            <ul>
                        ...
                        <xsl:if test="count(metamagics/metamagic) &gt; 0">
                            <strong>
                                <xsl:value-of select="$lang.Metamagics" />
                            </strong>
                            <ul>
                                <xsl:for-each select="metamagics/metamagic">
                                    <xsl:sort select="name" />
    ...
    <xsl:template name="print_ids">
        <table class="stats gear">
            <tr>
                <td>
                    <div class="bigheader">
                        [<xsl:value-of select="$lang.IDcredsticks" />]
                    </div>
                </td>
            </tr>
        ...
        <xsl:if test="background!=''">
            <table class="stats description">
                <tr>
                    <td>
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Background" />]
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <xsl:if test="concept!=''">
            <table class="stats description">
                <tr>
                    <td>
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Concept" />]
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <xsl:if test="hasothermugshots = 'True'">
            <table class="stats description">
                <tr>
                    <td>
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.OtherMugshots" />]
                        </div>
                    </td>
                </tr>
                <tr>
        ...
        <xsl:if test="count(calendar/week) &gt; 0">
            <table class="stats description">
                <tr>
                    <td colspan="2">
                        <div class="bigheader">
                            [<xsl:value-of select="$lang.Calendar" />]
                        </div>
                    </td>
                </tr>
                <tr class="smallheader">
        ...
        <strong>
            <xsl:choose>
                <xsl:when test="location=''">
                    <xsl:value-of select="$lang.SelectedGear" />
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="location" />
                </xsl:otherwise>
